...
import pe.gob.pj.cspide.infraestructure.client.services.ConadisClient;
...
public class ConsultarConadisController implements Serializable{
	...
	public ResponseEntity<GlobalResponse> buscarOficinas(@RequestAttribute(name=ProjectConstants.AUD_CUO) String cuo,
			...
			@Length(min = 8, max = 13, message = "El parámetro numeroDocumentoIdentidad tiene un tamaño no valido [min=1,max=13].") 
