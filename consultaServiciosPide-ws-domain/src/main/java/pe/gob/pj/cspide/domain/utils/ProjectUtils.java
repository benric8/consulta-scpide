...
public class ProjectUtils {
	...
	public static void handleException(String cuo, Exception e, String codigoError, String codigoMensaje) {
	    log.error("{} {} | {} | {} | {} | {} | {}", cuo, ProjectConstants.Error.TRAZA_LOG, codigoError, codigoMensaje, ProjectUtils.obtenerClaseMetodoLineaException(e), e.getMessage(), ProjectUtils.obtenerCausaException(e));
	}
	...
	public static String convertUTF8(String value) throws UnsupportedEncodingException {
	...
	public static String obtenerCausaException(Exception e) {
		...
		return causaString.trim().equalsIgnoreCase("") ? ProjectConstants.Error.CAUSA_NO_IDENTIFICADA : causaString;
	}
	...
	public static String obtenerClaseMetodoLineaException(Exception e) {
		...
		return claseMetodoLineaString.trim().equalsIgnoreCase("") ? ProjectConstants.Error.CML_NO_IDENTIFICADA : claseMetodoLineaString;
	}
